package com.dicoding.naufal.mymoviecatalog.ui.movies
...
import com.dicoding.naufal.mymoviecatalog.databinding.FragmentMoviesBinding
...
class MoviesFragment : Fragment(), ShowFragmentCallback {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (activity != null){
            ...
            viewModel.getMovies().observe(viewLifecycleOwner, {shows ->
                if (shows != null){
                    when(shows.status){
