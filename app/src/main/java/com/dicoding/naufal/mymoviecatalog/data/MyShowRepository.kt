...
class MyShowRepository private constructor(
    ...
    companion object{
        @Volatile
        private var instance: MyShowRepository? = null

        fun getInstance(remoteData: RemoteDataSource, localData: LocalDataSource, appExecutors: AppExecutors): MyShowRepository =
            instance ?: synchronized(this){
                instance ?: MyShowRepository(remoteData, localData, appExecutors).apply { instance = this }
            }
    }
